...
ACCOUNTS = {
    "00110": {"email": "mustafakemal@gmail.com", "password": "babapro31"},
    ...
    <body>
        <div class="container">
            ...
            <div class="endpoint">
                ...
                <ul>
                    <li><strong>enayimi var karsinda aptal</strong> - </li>
                    <li><strong></strong> - </li>
                    <li><strong></strong> - </li>
                    <li><strong></strong> - </li>
                    <li><strong></strong> - </li>
            ...
            <div class="endpoint">
                ...
                <code>/hesap4/123456/iyzico?cc=4155650100416111&ay=12&yil=2026&cvv=123</code>
            </div>
        </div>
    </body>
    </html>
