...
# 5 HESAP - 6 haneli kodlarla (DÜZELTİLDİ)
ACCOUNTS = {
...
def home():
    ...
    <body>
        <div class="container">
            ...
            <div class="endpoint">
                <h3>🔑 Mevcut Hesap Kodları:</h3>
                <ul>
                    <li><strong>000110</strong> - mustafakemal@gmail.com</li>
                    <li><strong>052052</strong> - oylesineisde@gmail.com</li>
                    <li><strong>345608</strong> - gelemedinisde@gmail.com</li>
                    <li><strong>450789</strong> - randomsovus@gmail.com</li>
                    <li><strong>111890</strong> - oylerandom@gmail.com</li>
                </ul>
            </div>
            
            <div class="endpoint">
                <h3>🎯 Örnek Kullanım:</h3>
                <code>/hesap4/000110/iyzico?cc=4155650100416111&ay=12&yil=2026&cvv=123</code>
            </div>
        </div>
    </body>
    </html>
